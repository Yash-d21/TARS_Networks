...
const Tars: React.FC = () => {
  ...
  return (
    <div className="relative w-64 h-96 perspective-1000 group cursor-pointer"
    ...
    >
      ...
      <motion.div className="absolute -right-24 top-10 font-mono text-xs text-gray-200 flex flex-col gap-2 font-bold tracking-widest" initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }}>
